    ...
    <div className="flex items-center justify-between py-3 border-b border-[var(--color-border)]">
      ...
      <div className="flex items-center gap-3">
        <input type="text" value={form[field]}
          ...
          className="w-28 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded px-2 py-1 text-xs font-mono focus:outline-none focus:border-[#C78C00]"
          style={{ color: 'var(--color-text)' }} />
        <div className="relative w-10 h-10 rounded-lg border border-[var(--color-border)] overflow-hidden cursor-pointer"
    ...
    <div className="p-6 space-y-6 max-w-3xl">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-medium transition-all ${
              form.themeMode === 'dark' ? 'border-[#C78C00]' : 'border-[var(--color-border)] hover:border-[var(--color-muted)]'
            }`}
            style={{
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-medium transition-all ${
              form.themeMode === 'light' ? 'border-[#C78C00]' : 'border-[var(--color-border)] hover:border-[var(--color-muted)]'
            }`}
            style={{
      ...
      <div className="bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-xl p-5">
        ...
        <div>
          ...
          <input value={form.siteName} onChange={e => setForm({ ...form, siteName: e.target.value })}
            className="w-full bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#C78C00] max-w-xs"
            style={{ color: 'var(--color-text)' }}
      ...
      <div className="bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="border-2 border-dashed border-[var(--color-border)] rounded-xl p-4 text-center hover:border-[#C78C00]/50 transition-colors cursor-pointer"
      ...
      <div className="flex gap-3">
        <button onClick={applyPreview}
          className="flex items-center gap-2 px-4 py-2 bg-[var(--color-surface-2)] hover:bg-[var(--color-surface-hover)] border border-[var(--color-border)] rounded-lg text-sm transition-colors"
          style={{ color: 'var(--color-text-muted)' }}>
